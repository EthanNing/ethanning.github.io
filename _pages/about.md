...
<li><strong>2024.01</strong>: Officially promoted to T9 Senior Data Scientist at Tencent</li>
<li><strong>2023.07</strong>: Received "Outstanding Employee" (top 10%) performance evaluation at Tencent</li>
</ul>
</section>
...
<div class="career-item">
  <div class="career-logo">
    <img src="/images/cmu-lti-logo.png" alt="CMU LTI Logo">
  </div>
  <div class="career-content">
    <h3>Research Assistant | Carnegie Mellon University</h3>
    <p><strong>Dec 2024 – Present</strong> | Pittsburgh, PA</p>
    <ul>
    <li>Pursuing research at the intersection of LLMs and Information Retrieval</li>
    <li>Supervised by Prof. Jamie Callan (former SIGIR Chair)</li>
    <li>Primarily researching RAG systems and DeepResearch systems, with strong interests in Agents and query understanding</li>    </ul>
  </div>
</div>
